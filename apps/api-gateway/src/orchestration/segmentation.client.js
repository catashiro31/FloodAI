...
var SegmentationClient_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.SegmentationClient = void 0;
const axios_1 = require("@nestjs/axios");
const common_1 = require("@nestjs/common");
const config_1 = require("@nestjs/config");
const rxjs_1 = require("rxjs");
let SegmentationClient = SegmentationClient_1 = class SegmentationClient {
    constructor(httpService, configService) {
        this.httpService = httpService;
        this.configService = configService;
        this.logger = new common_1.Logger(SegmentationClient_1.name);
    }
    async trigger(jobId, callbackUrl) {
        const endpoint = this.configService.get("SEGMENT_SERVICE_URL");
        if (!endpoint) {
        ...
        for (const candidate of candidates) {
            try {
                ...
                this.logger.warn(`Segmentation endpoint returned 404 for ${candidate}. Retrying fallback endpoint...`);
            }
        }
...
exports.SegmentationClient = SegmentationClient;
exports.SegmentationClient = SegmentationClient = SegmentationClient_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [axios_1.HttpService,
        config_1.ConfigService])
], SegmentationClient);
//# sourceMappingURL=segmentation.client.js.map