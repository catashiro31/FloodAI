...
if __name__ == "__main__":
    TRAIN_IMG_DIR = 'FloodNet-Supervised_v1.0/train/train-org-img'
    TRAIN_MASK_DIR = 'FloodNet-Supervised_v1.0/train/train-label-img'
    VAL_IMG_DIR = 'FloodNet-Supervised_v1.0/val/val-org-img'
    VAL_MASK_DIR = 'FloodNet-Supervised_v1.0/val/val-label-img'
    ...
    print(f"Đang chạy U-Net++ trên thiết bị: {device}")
    
    model = smp.UnetPlusPlus(encoder_name="resnet101", encoder_weights="imagenet", in_channels=3, classes=10).to(device)
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if epoch_val_iou > best_val_iou:
            ...
            torch.save(model.state_dict(), "best_floodnet_unetplusplus.pth")
            print(f"🔥 Đã lưu mô hình tốt nhất với mIoU: {best_val_iou:.4f}")

    print("Quá trình huấn luyện U-Net++ đã hoàn tất!")