...
if __name__ == "__main__":
    ...
    model = smp.DeepLabV3Plus(encoder_name="resnet101", encoder_weights="imagenet", in_channels=3, classes=10).to(device)
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if epoch_val_iou > best_val_iou:
            ...
            torch.save(model.state_dict(), "best_floodnet_deeplabv3plus.pth")
